          ...
          contents: [
            {
              parts: [
                {
text: `
You are a senior plant virologist specializing in tomato diseases.
...
Generate a detailed evidence-based HTML report specifically for Tomato Mosaic Virus.

Tomato Mosaic Virus is caused by:
...
Closely related viruses include:

- Tobacco Mosaic Virus (TMV)

Include information about:

- light and dark green mosaic leaf patterns
- leaf curling
- leaf distortion
- fern-like leaves
- stunted growth
...
- weed control
- crop hygiene
- avoiding tobacco contamination
- integrated disease management

Mention that pesticides cannot cure viral infections.

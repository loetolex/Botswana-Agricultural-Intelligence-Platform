          ...
          contents: [
            {
              parts: [
                {
text: `
You are a senior agricultural entomologist specializing in tomato pests.
...
Generate a detailed evidence-based HTML report specifically for Spider Mites in Tomato.
...
Mention biological control agents including:

- Phytoseiulus persimilis
- Neoseiulus californicus

Mention miticides where appropriate including:
...
Explain pesticide resistance management and that pesticide use should follow national agricultural regulations.
...
- scouting frequency
- monitoring underside of leaves
- counting mite populations
- monitoring webbing
